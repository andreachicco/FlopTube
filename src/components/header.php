<header class="w-full h-header shadow-sm md:shadow-md lg:shadow-lg">
    <div class="wrapper w-sm-container sm:w-container w-4/5 mx-auto h-full">
        <nav class="flex items-center justify-between h-full">
            ...
            <ul class="links bg-white absolute justify-around h-1/2 w-screen top-0 left-[100vw] flex flex-col sm:flex-row sm:bg-transparent sm:static sm:justify-end items-center list-none">
                <li class="text-sm hover:text-ft-red p-sm-nav-links md:p-md-nav-links lg:p-lg-nav-links"><a href="#">Home</a></li>
                <li class="text-sm hover:text-ft-red p-sm-nav-links md:p-md-nav-links lg:p-lg-nav-links"><a href="#">Videos</a></li>
                <li class="text-sm hover:text-ft-red p-sm-nav-links md:p-md-nav-links lg:p-lg-nav-links"><a href="#">SignIn</a></li>
                <li class="text-sm hover:text-ft-red p-sm-nav-links md:p-md-nav-links lg:p-lg-nav-links"><a href="#">SignUp</a></li>
            </ul>
        </nav>
    </div>
</header>
